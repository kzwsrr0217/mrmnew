// mrmnew/frontend/src/components/SystemDetail.tsx
                    ...
                    <tbody>
                        {mainHardware.map(hw => (
                            <tr key={hw.hardware_id}>
                                ...
                                <td style={thTdStyle}>{`${hw.manufacturer || ''} ${hw.model_name}`}</td>
                                <td style={thTdStyle}>{hw.serial_number}</td>
                                <td style={thTdStyle}>
                                    {hw.location ? (
                                        <ExpandableRow title={`${hw.location.building || ''} ${hw.location.room}`}>
                                            <p style={{ margin: 0 }}><strong>Teljes cím:</strong> {hw.location.full_address}</p>
                                        </ExpandableRow>
                                    ) : 'N/A'}
                                </td>
                                <td style={thTdStyle}>
                                ...
                                <td style={thTdStyle}>
                                    {hw.notes && <ExpandableRow title="Megjegyzés...">{hw.notes}</ExpandableRow>}
                                </td>
                                <td style={thTdStyle}>
